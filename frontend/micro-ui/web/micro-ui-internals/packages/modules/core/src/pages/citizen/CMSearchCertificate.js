...
import { TextInput, SubmitBar, SearchForm, Dropdown, SearchField, Table, Toast } from "@djb25/digit-ui-react-components";
...
const VSearchCertificate = () => {
  ...
  const { data: type_of_certificate } = Digit.Hooks.useCustomMDMS(
  ...
  return (
    <React.Fragment>
      <div style={{ width: "80%", marginLeft: "10%" }}>
        <div className="h1" style={{ fontSize: "40px", fontFamily: "Roboto Condensed" }}>
          {t("SEARCH_CERTIFICATE")}
        </div>
        <SearchForm onSubmit={onSubmit} handleSubmit={handleSubmit}>
          ...
          <SearchField className="submit">
            <SubmitBar label={t("ES_COMMON_SEARCH")} submit disabled={!ishuman || !certificate_name || !certificate_No} />
            <p
