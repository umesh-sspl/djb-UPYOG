...
export const emergencyWaterTankerPayload = (data) => {
  ...
  const formdata = {
    waterTankerBookingDetail: {
      ...
      address: {
        addressType: data?.address?.addressType?.code || data?.address?.addressType || "OTHER",
        pincode: data?.address?.pincode,
        city: data?.address?.city?.city?.name || data?.address?.city?.name || data?.address?.city || "",
        cityCode: data?.address?.city?.city?.code || data?.address?.city?.code || data?.address?.cityCode || "DJB",
        addressLine1: data?.address?.addressLine1,
        addressLine2: data?.address?.addressLine2,
        locality: data?.address?.locality?.i18nKey || data?.address?.locality?.name || data?.address?.locality || "",
        localityCode: data?.address?.locality?.code || data?.address?.localityCode || "",
        streetName: data?.address?.streetName,
        houseNo: data?.address?.houseNo,
        landmark: data?.address?.landmark,
        latitude: data?.address?.latitude,
        longitude: data?.address?.longitude,
        ward: data?.address?.block || "",
        zone: data?.address?.zone || "",
        constituency: data?.address?.assembly || "",
      },
      WTfileStoreId: data?.requestDetails?.fileStoreId,
      bookingStatus: "BOOKING_CREATED",
      workflow: {
