...
const Close = ({ className = "", style = {}, width = 24, height = 24, fill = "#9E9E9E", onClick }) => (
  <svg
    focusable="false"
    viewBox="0 0 24 24"
    aria-hidden="true"
...
const MdClose = ({ width = 24, height = 24, fill = "white", className = "" }) => (
...
const VendorManagementIcon = ({ size = 24, color = "currentColor", className = "" }) => {
  return (
    <svg
      stroke="currentColor"
      fill={color}
