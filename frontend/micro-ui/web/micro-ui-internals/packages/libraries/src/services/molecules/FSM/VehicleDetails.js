  ...
  let details = [
    {
      ...
      values: [
        ...
        { title: "ES_FSM_REGISTRY_NEW_VEHICLE_OWNER_NAME", value: data?.owner?.name },
        { title: "ES_FSM_REGISTRY_NEW_VEHICLE_OWNER_PHONE", value: data?.owner?.mobileNumber },
        { title: "ES_FSM_REGISTRY_NEW_EMAIL", value: data?.owner?.emailId },
